...
namespace DDX.NHibernateHelper
{
    public sealed class NhbHelper
    {
        ...
        public static bool IsBuildScheme { get; set; }
        /// <summary>
        /// 创建NHibernate配置
        /// </summary>
        private static Configuration CreateConfiguration()
        {
            ...
            var strAppType = appReader.GetValue("AppType", typeof(String));
             var strDllName = appReader.GetValue("DllName", typeof(String));
            string dllName = System.Configuration.ConfigurationManager.ConnectionStrings["defaultConnection"].ConnectionString;//配置文件中取
            Configuration cfg = FluentNHibernate.Cfg.Fluently.Configure()
                           ...
                           .Mappings(m => m.FluentMappings
                               .AddFromAssembly(Assembly.Load(strDllName.ToString()))
